...
; Function Attrs: nounwind uwtable
define void @getVectorAtVector(i32* %newVector, i32* %vector, i32* %index) #0 {
  %1 = alloca i32*, align 8
  %2 = alloca i32*, align 8
  %3 = alloca i32*, align 8
  %i = alloca i32, align 4
  store i32* %newVector, i32** %1, align 8
  store i32* %vector, i32** %2, align 8
...
define i32 @main(i32 %argc, i8** %argv) #0 {
  ...
  call void @allocateVec(i32** %x, i32 3)
  %3 = load i32** %x, align 8
  %4 = getelementptr inbounds i32* %3, i64 0
  ...
  %10 = getelementptr inbounds i32* %9, i64 3
  store i32 3, i32* %10, align 4
  %11 = load i32** %x, align 8
  %12 = call i32 @getVectorAtInt(i32* %11, i32 0)
  store i32 %12, i32* %a, align 4
  %13 = load i32** %x, align 8
  %14 = call i32 @getVectorAtInt(i32* %13, i32 0)
  %15 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([3 x i8]* @.str1, i32 0, i32 0), i32 %14)
  ret i32 0
}
